...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="box-shadow: 13px 13px 20px #cbced1;">
    <div class="container-fluid">
        <!-- navbar brand -->
        <a class="navbar-brand" href="home.php" style="padding: 2px 2px; font-weight: bold; font-size: x-large; color: #174966; font-family: 'Roboto Slab', serif;">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if ($isLogged) {
                    if ($title == "Home") {
                        ...
                        <a class="nav-link" href="index.php">Index</a></li>';
                    }
                } ?>
            </ul>
